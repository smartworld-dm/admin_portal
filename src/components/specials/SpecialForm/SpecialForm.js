...
class SpecialForm extends Component {
  ...
  handleInitialize() {
    const {
      item,
      item: {
        incentive_name, category, incentive_type, attendee_min, amount, item_name, description, location_pointer,
    ...
    if (!isEmpty(item)) {
      ...
      initialize({
        ...
        incentive_name, category, incentive_type, attendee_min, amount, item_name, description, location_pointer,
        redemption_options, promo_code, days, without_end_date, image
      });
    }
  }
