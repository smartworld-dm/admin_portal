...
function PlanTemplateDelete({ itemID, onDelete }) {
  return (
    <div className="row">
      <div className="col-lg-12">
        <div className="panel panel-danger">
          ...
          <div className="panel-body">
            <LinkTo url={`planTemplates/${itemID}`}>PlanTemplate #{itemID}</LinkTo>
          </div>
        </div>
...
PlanTemplateDelete.propTypes = {
  itemID: PropTypes.string.isRequired,
  onDelete: PropTypes.func.isRequired
};

export default PlanTemplateDelete;