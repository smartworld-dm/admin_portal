...
function PlansList({ items, onSort }) {
  return (
    <table className="table table-bordered table-hover table-striped table-responsive">
      ...
      <tr>
        ...
        <th>Title</th>
        <th>Tags</th>
        <th onClick={() => onSort("neighborhood")}>Neighborhood</th>
        <th onClick={() => onSort("start")}>
          Start
        </th>
        <th onClick={() => onSort("end")}>
          End
        </th>
        <th />
        {/*<th />*/}
        ...
        <tr key={objectId}>
          ...
          <td>
            <LinkTo className="btn btn-primary" url={`plans/${objectId}/edit`}>Edit</LinkTo>
		      ...
		      <td>
            <LinkTo className="btn btn-primary" url={`plans/${objectId}/copy`}>Copy</LinkTo>
          </td>
          <td>
