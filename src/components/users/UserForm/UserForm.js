...
class UserForm extends Component {
  ...
  handleInitialize() {
    const {
      item,
      item: {
        first_name, last_name, full_name, user_email, gender, age_count, bio, birthday, education_history, phone, tags, verified,
    ...
    if (!isEmpty(item)) {
      initialize({
        first_name: first_name || (full_name ? first(full_name.split(' ')) : null),
		last_name:  last_name || (full_name ? (last(full_name.split(' '))) : null),
		full_name, user_email, gender, age_count, bio, education_history, phone, tags,
