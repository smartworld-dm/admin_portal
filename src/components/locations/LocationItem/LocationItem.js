...
function LocationItem({
  item: {
    objectId, name, address, phone, website, category, neighborhood, metro_city, hours, reservations, latitude, longitude, rating, notes, additional_notes, 
    groups, outdoor, location_type, verified, createdAt, tags, ticket_url, yelp_reservation, skip_automation
  }
}) {
  return (
    <div>
      ...
      <table className="table table-bordered table-hover table-striped table-responsive">
        ...
        <tr>
          <td>Yelp Reservation</td>
          <td><BooleanField value={yelp_reservation} /></td>
        </tr>
        <tr>
          <td>Skip Automation</td>
          <td><BooleanField value={skip_automation} /></td>
        </tr>
        <tr>
          <td>Created</td>
