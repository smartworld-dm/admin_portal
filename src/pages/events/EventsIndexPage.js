...
class EventsIndexPage extends Component {
  ...
  fetchData({ search, order, filters, include }) {
    ...
    const fakeUser = { 'is_admin': true };
    this.setState({ search, fetched: false }, () => fetchEvents({ order, search, filters, include }, fakeUser)
      ...
      <Loading className="container" ignoreLoader={(
        <div className="row m-b">
          <div className="col-md-3">
			...
			<LinkTo className="btn btn-default" url="events/bulkupload">Bulk Upload</LinkTo>
          </div>
